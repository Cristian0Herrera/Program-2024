...
Vue.component('matriculas',{
    ...
    <div class="container">
    <div class="row">
        <!-- Columna del Formulario de Matrícula -->
        <div class="col-md-6">
        ...
        <!-- Columna de la Consulta de Matrículas -->
        <div class="col-md-6">
            <div class="card text-bg-light" style="max-height: 400px; overflow-y: auto;">
                <div class="card-header">CONSULTA DE MATRÍCULAS</div>
                    ...
                    <form>
                        <table class="table table-dark table-hover mb-0">
                            <thead>
                                <tr>
                                    <th>BUSCAR</th>
                                    <th colspan="3"><input type="text" @keyup="listar()" class="form-control" v-model="buscar" placeholder="Buscar por nombre"></th>
                                </tr>
                                <tr>
                                    <th>NOMBRE</th>
                                    <th>FECHA</th>
