  ...
  methods:{
      ...
      guardarInscripcion(){
          ...
          query.onsuccess = resp=>{
              fetch(`private/modulos/inscripciones/inscripciones.php?accion=${this.accion}&inscripcion=${JSON.stringify(this.inscripcion)}`)
              .then(resp=>resp.json())
              .then(resp=>{
                  console.log(resp);
              });
    ...
    <div class="col-12 col-md-10">
        <div class="card text-bg-light">
            ...
            <div class="card-body" style="max-height: 400px; overflow-y: auto;">
                <form>
                    <table class="table table-dark table-hover" style="height: 300px;">
                        <thead>
                            <tr>
                                <th>BUSCAR</th>
                                <th colspan="2"><input type="text" @keyup="listar()" class="form-control" v-model="buscar" placeholder="Buscar por nombre"></th>
                            </tr>
                            <tr>
                                <th>CODIGO</th>
                                <th>NOMBRE</th>
